...
async function startNight(){
	...
	if(selectedRoles.troublemaker){
		...
		troublemakerWakeUp.play()
		await wait(15000)

		troublemakerOut.play()
		await wait(5000)
	...
	if(selectedRoles.insomniac){
		...
		if(selectedRoles.doppelganger){
			...
			doppelInsomniac.play()
			await wait(14000)
			
			doppelInsomniacOut.play()
			await wait(7000)
